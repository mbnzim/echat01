            ...
            ? ListView(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: _user.about.isNotEmpty ? Text(_user.about) : Container(),
                  ),
                  Padding(
                      ...
                      children: <Widget>[
                        GestureDetector(
                          ...
                          onTap: () {
                            setState(() {
                              _isGridActive = true;
                              _gridColor = Theme.of(context).accentColor;
                        ...
                        GestureDetector(
                          ...
                          onTap: () {
                            setState(() {
                              _isGridActive = false;
                              _listColor = Theme.of(context).accentColor;
